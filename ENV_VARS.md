...
| TA_GOAGENT_FILTER_THREAD_POOL_TIMEOUT | Specifies the maximum duration to wait for a free slot in the buffer. if this interval elapses without finding a free slot, the pending event will be discarded. |
