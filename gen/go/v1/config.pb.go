...
func (x *AgentConfig) GetDetectionConfig() *ThreatActivityDetection {
	if x != nil {
...
type ThreatActivityDetection struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Enabled       *wrapperspb.BoolValue  `protobuf:"bytes,1,opt,name=enabled,proto3" json:"enabled,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
...
func (x *ThreatActivityDetection) Reset() {
	*x = ThreatActivityDetection{}
	mi := &file_ai_traceable_agent_config_v1_config_proto_msgTypes[26]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ThreatActivityDetection) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ThreatActivityDetection) ProtoMessage() {}

func (x *ThreatActivityDetection) ProtoReflect() protoreflect.Message {
	mi := &file_ai_traceable_agent_config_v1_config_proto_msgTypes[26]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ThreatActivityDetection.ProtoReflect.Descriptor instead.
func (*ThreatActivityDetection) Descriptor() ([]byte, []int) {
	return file_ai_traceable_agent_config_v1_config_proto_rawDescGZIP(), []int{26}
}

func (x *ThreatActivityDetection) GetEnabled() *wrapperspb.BoolValue {
	if x != nil {
		return x.Enabled
	}
	return nil
...
const file_ai_traceable_agent_config_v1_config_proto_rawDesc = "" +
	"\n" +
	")ai/traceable/agent/config/v1/config.proto\x12\x1cai.traceable.agent.config.v1\x1a\x1egoogle/protobuf/wrappers.proto\"\xf2\f\n" +
	"\vAgentConfig\x12U\n" +
	...
	"\rremote_config\x18\x04 \x01(\v2*.ai.traceable.agent.config.v1.RemoteConfigR\fremoteConfig\x12H\n" +
	...
	"\x10detection_config\x18\x16 \x01(\v25.ai.traceable.agent.config.v1.ThreatActivityDetectionR\x0fdetectionConfig\x1aE\n" +
	...
	" \x01(\x0e2-.ai.traceable.agent.config.v1.CompressionTypeR\x0fcompressionType\"\xeb\x06\n" +
	"\x0eBlockingConfig\x124\n" +
	"\aenabled\x18\x01 \x01(\v2\x1a.google.protobuf.BoolValueR\aenabled\x12Q\n" +
	...
	"\x0fregion_blocking\x18\x05 \x01(\v22.ai.traceable.agent.config.v1.RegionBlockingConfigR\x0eregionBlocking\x12N\n" +
	...
	"\x15use_secure_connection\x18\x06 \x01(\v2\x1a.google.protobuf.BoolValueR\x13useSecureConnection\"\xb0\x01\n" +
